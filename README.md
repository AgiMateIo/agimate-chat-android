...
Земля приложения — не цвет, а кисть: роль `backdrop` собрана из двух токенов подложки и
растягивается по высоте того, на чём нарисована. Красит ею корень экрана, а не полосу внутри него,
иначе полоса покажет весь градиент, сжатый в свою высоту.
